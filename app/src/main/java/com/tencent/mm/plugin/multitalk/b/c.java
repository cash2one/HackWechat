...
public final class c extends i<b> {
    public static final String[] gJN = new String[]{i.a(b.gJc, "MultiTalkMember"), "CREATE INDEX IF NOT EXISTS idx_MultiTalkMember  on MultiTalkMember  (  wxGroupId )"};

    public c(e eVar) {
        super(eVar, b.gJc, "MultiTalkMember", null);
    }
    ...
    public final LinkedList<b> FF(String str) {
    ...
    public final boolean bP(String str, String str2) {
        ...
        try {
            super.fx("MultiTalkMember", "delete from MultiTalkMember where wxGroupId = \"" + str + "\" and userName = \"" + str2 + "\"");
            return true;
        } catch (Exception e) {
    ...
    public final boolean iF(String str) {
        ...
        try {
            super.fx("MultiTalkMember", "delete from MultiTalkMember where wxGroupId = \"" + str + "\"");
            return true;
        } catch (Exception e) {
