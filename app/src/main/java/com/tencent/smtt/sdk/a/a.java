...
public final class a {
    public static final byte[] Aaa = new byte[]{(byte) 98, (byte) -24, (byte) 57, (byte) -84, (byte) -115, (byte) 117, (byte) 55, (byte) 121};
    public static final byte[] Aab = new byte[]{(byte) -25, (byte) -101, (byte) -115, (byte) 1, (byte) 47, (byte) 7, (byte) -27, (byte) -59, (byte) 18, Byte.MIN_VALUE, (byte) 123, (byte) 79, (byte) -44, (byte) 37, (byte) 46, (byte) 115};
    public static final byte[] Aac = new byte[]{(byte) 37, (byte) -110, (byte) 60, Byte.MAX_VALUE, (byte) 42, (byte) -27, (byte) -17, (byte) -110};
    public static final byte[] Aad = new byte[]{(byte) -122, (byte) -8, (byte) -23, (byte) -84, (byte) -125, (byte) 113, (byte) 84, (byte) 99};
    public static final byte[] Aae = "AL!#$AC9Ahg@KLJ1".getBytes();
    private static final int[] zZS = new int[]{58, 50, 42, 34, 26, 18, 10, 2, 60, 52, 44, 36, 28, 20, 12, 4, 62, 54, 46, 38, 30, 22, 14, 6, 64, 56, 48, 40, 32, 24, 16, 8, 57, 49, 41, 33, 25, 17, 9, 1, 59, 51, 43, 35, 27, 19, 11, 3, 61, 53, 45, 37, 29, 21, 13, 5, 63, 55, 47, 39, 31, 23, 15, 7};
    private static final int[] zZT = new int[]{40, 8, 48, 16, 56, 24, 64, 32, 39, 7, 47, 15, 55, 23, 63, 31, 38, 6, 46, 14, 54, 22, 62, 30, 37, 5, 45, 13, 53, 21, 61, 29, 36, 4, 44, 12, 52, 20, 60, 28, 35, 3, 43, 11, 51, 19, 59, 27, 34, 2, 42, 10, 50, 18, 58, 26, 33, 1, 41, 9, 49, 17, 57, 25};
    private static final int[] zZU = new int[]{57, 49, 41, 33, 25, 17, 9, 1, 58, 50, 42, 34, 26, 18, 10, 2, 59, 51, 43, 35, 27, 19, 11, 3, 60, 52, 44, 36, 63, 55, 47, 39, 31, 23, 15, 7, 62, 54, 46, 38, 30, 22, 14, 6, 61, 53, 45, 37, 29, 21, 13, 5, 28, 20, 12, 4};
    private static final int[] zZV = new int[]{14, 17, 11, 24, 1, 5, 3, 28, 15, 6, 21, 10, 23, 19, 12, 4, 26, 8, 16, 7, 27, 20, 13, 2, 41, 52, 31, 37, 47, 55, 30, 40, 51, 45, 33, 48, 44, 49, 39, 56, 34, 53, 46, 42, 50, 36, 29, 32};
    private static final int[] zZW = new int[]{32, 1, 2, 3, 4, 5, 4, 5, 6, 7, 8, 9, 8, 9, 10, 11, 12, 13, 12, 13, 14, 15, 16, 17, 16, 17, 18, 19, 20, 21, 20, 21, 22, 23, 24, 25, 24, 25, 26, 27, 28, 29, 28, 29, 30, 31, 32, 1};
    private static final int[] zZX = new int[]{16, 7, 20, 21, 29, 12, 28, 17, 1, 15, 23, 26, 5, 18, 31, 10, 2, 8, 24, 14, 32, 27, 3, 9, 19, 13, 30, 6, 22, 11, 4, 25};
    private static final int[][][] zZY;
    private static final int[] zZZ = new int[]{1, 1, 2, 2, 2, 2, 2, 2, 1, 2, 2, 2, 2, 2, 2, 1};
            ...
            for (int i5 = 0; i5 < i4; i5++) {
                ...
                for (i6 = 0; i6 < 16; i6++) {
                    ...
                    for (i8 = 0; i8 < 8; i8++) {
                        ...
                        iArr11[i8] = zZY[i8][(iArr10[i8][0] << 1) + iArr10[i8][5]][(((iArr10[i8][1] << 3) + (iArr10[i8][2] << 2)) + (iArr10[i8][3] << 1)) + iArr10[i8][4]];
                        for (i9 = 0; i9 < 4; i9++) {
