...
public class DefaultMediaHTTPConnection implements IMediaHTTPConnection {
    ...
    private void seekTo(long j) {
        ...
        while (true) {
            ...
            if (responseCode != 300 && responseCode != 301 && responseCode != HardCoderJNI.SCENE_QUIT_CHATTING && responseCode != 303 && responseCode != HTTP_TEMP_REDIRECT) {
                break;
            }
            int i2 = i + 1;
            if (i2 > 20) {
        ...
        if (j <= 0 || responseCode == b.CTRL_INDEX) {
