...
import com.tencent.mm.by.a.c.a;
    ...
    final int a(c cVar, int i, int i2) {
        ...
        while (i4 < i3) {
            if (step(1) == 1) {
                Object[] objArr;
                int i5 = i4 / cVar.xBM;
                if (cVar.xBL.indexOfKey(i5) < 0) {
                    obj = new Object[(cVar.xBM * cVar.columnCount)];
                    cVar.xBL.put(i5, obj);
                    objArr = obj;
                } else {
                    objArr = (Object[]) cVar.xBL.get(i5);
                }
                int i6 = cVar.columnCount * (i4 % cVar.xBM);
