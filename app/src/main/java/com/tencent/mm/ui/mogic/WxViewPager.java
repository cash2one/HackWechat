...
public class WxViewPager extends ViewGroup {
    ...
    private static final e zfw = new e();
    ...
    public Scroller yJ = new com.tencent.mm.plugin.music.ui.MusicViewPager.a(this, getContext());
    private int yM;
    private Drawable yN;
    private int yO;
    private int yP;
    ...
    public static class LayoutParams extends android.view.ViewGroup.LayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, WxViewPager.yz);
    ...
    public void a(u uVar) {
        if (this.yE != null) {
            int i;
            this.yE.unregisterDataSetObserver(this.zfv);
        ...
        if (this.yE != null) {
            if (this.zfv == null) {
                this.zfv = new d(this, (byte) 0);
            }
            this.yE.registerDataSetObserver(this.zfv);
            this.yV = false;
            boolean z = this.zj;
            this.zj = true;
    ...
    private void a(int i, boolean z, int i2, boolean z2) {
        ...
        int i3 = 0;
        if (GG != null) {
            i3 = (int) (((float) bQ()) * Math.max(this.yQ, Math.min(GG.zA, this.yR)));
        }
        if (z) {
            if (getChildCount() == 0) {
                setScrollingCacheEnabled(false);
    ...
    private void ai(int i) {
        ...
        if (this.yE == null) {
            ...
            if (hasFocus()) {
                ...
                bVar2 = findFocus != null ? dK(findFocus) : null;
                if (bVar2 == null || bVar2.position != this.yF) {
                    i3 = 0;
                    while (i3 < getChildCount()) {
                        View childAt2 = getChildAt(i3);
                        b dJ = dJ(childAt2);
                        if (dJ == null || dJ.position != this.yF || !childAt2.requestFocus(r3)) {
                            i3++;
                        } else {
                            return;
                        }
    ...
    public void onSizeChanged(int i, int i2, int i3, int i4) {
        ...
        if (i != i3) {
            ...
            if (i3 <= 0 || this.ep.isEmpty()) {
                b GG = GG(this.yF);
                i5 = (int) ((GG != null ? Math.min(GG.zA, this.yR) : 0.0f) * ((float) ((i - getPaddingLeft()) - getPaddingRight())));
                if (i5 != getScrollX()) {
                    q(false);
            ...
            if (!this.yJ.isFinished()) {
                int duration = this.yJ.getDuration() - this.yJ.timePassed();
                b GG2 = GG(this.yF);
                if (GG2 != null) {
                    this.yJ.startScroll(i6, 0, (int) (GG2.zA * ((float) i)), 0, duration);
                }
            }
        }
    }
        ...
        for (paddingRight = 0; paddingRight < childCount; paddingRight++) {
            ...
            if (childAt2.getVisibility() != 8) {
                ...
                if (!layoutParams.zB) {
                    b dJ = dJ(childAt2);
                    if (dJ != null) {
                        i5 = ((int) (dJ.zA * ((float) max))) + paddingLeft;
                        if (layoutParams.zC) {
    ...
    private boolean ak(int i) {
        ...
        int i3 = cxs.position;
        float f2 = ((((float) i) / ((float) bQ)) - cxs.zA) / (cxs.zz + f);
        bQ = (int) (((float) i2) * f2);
        this.zl = false;
        a(i3, f2, bQ);
        if (this.zl) {
    ...
    public boolean H(float f, float f2) {
        return (f < ((float) this.yZ) && f2 > 0.0f) || (f > ((float) (getWidth() - this.yZ)) && f2 < 0.0f);
    }
        ...
        switch (action) {
            ...
            case 2:
                ...
                if (action != -1) {
                    ...
                    if (f == 0.0f || H(this.za, f) || !a(this, false, (int) f, (int) d, (int) e)) {
        ...
        switch (motionEvent.getAction() & 255) {
            ...
            case 1:
                if (this.iL) {
                    ...
                    if (cxs != null) {
                        int i = cxs.position;
                        f = ((((float) scrollX) / ((float) bQ)) - cxs.zA) / cxs.zz;
                        bQ = o.b(motionEvent, this.fu);
                        if (bQ < 0) {
                            bQ = 0;
                        }
                        if (Math.abs((int) (o.d(motionEvent, bQ) - this.xP)) <= this.ze || Math.abs(a) <= this.zc) {
                            bQ = (int) ((i >= this.yF ? 0.6f : 0.4f) + (((float) i) + f));
                        } else {
                            bQ = a > 0 ? i : i + 1;
                        }
                        if (this.ep.size() > 0) {
                            bQ = Math.max(cpM(), Math.min(bQ, cpN()));
                        }
                        a(bQ, true, true, a);
                    }
                    this.fu = -1;
            ...
            case 2:
                if (!this.iL) {
                    ...
                    float abs = Math.abs(d - this.za);
                    f = o.e(motionEvent, bQ);
                    x = Math.abs(f - this.zb);
                    if (abs > ((float) this.iN) && abs > x) {
                        this.iL = true;
                        if (d - this.xP > 0.0f) {
    ...
    public int cpM() {
        return ((b) this.ep.get(0)).position;
    }

    public int cpN() {
        return ((b) this.ep.get(this.ep.size() - 1)).position;
    }
        ...
        if (descendantFocusability != 393216) {
            for (int i3 = 0; i3 < getChildCount(); i3++) {
                ...
                if (childAt.getVisibility() == 0) {
                    b dJ = dJ(childAt);
                    if (dJ != null && dJ.position == this.yF) {
    ...
    protected boolean onRequestFocusInDescendants(int i, Rect rect) {
        ...
        while (i2 != childCount) {
            ...
            if (childAt.getVisibility() == 0) {
                b dJ = dJ(childAt);
                if (dJ != null && dJ.position == this.yF && childAt.requestFocus(i, rect)) {
                    return true;
                }
            }
            i2 += i3;
    ...
    public boolean dispatchPopulateAccessibilityEvent(AccessibilityEvent accessibilityEvent) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (childAt.getVisibility() == 0) {
                b dJ = dJ(childAt);
                if (dJ != null && dJ.position == this.yF && childAt.dispatchPopulateAccessibilityEvent(accessibilityEvent)) {
                    return true;
                }
            }
        }
