...
public final class amz extends bdf {
    public String vQQ;
    public String wbr;
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        com_tencent_mm_protocal_c_amz.wJr = feVar;
                    }
                    return 0;
                case 2:
                    com_tencent_mm_protocal_c_amz.wbr = aVar3.Avy.readString();
                    return 0;
                case 3:
                    com_tencent_mm_protocal_c_amz.vQQ = aVar3.Avy.readString();
                    return 0;
                default:
                    return -1;
            }
