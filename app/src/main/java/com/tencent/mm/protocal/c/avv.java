...
public final class avv extends bdf {
    public int lOr;
    public String lOs;
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        com_tencent_mm_protocal_c_avv.wJr = feVar;
                    }
                    return 0;
                case 2:
                    com_tencent_mm_protocal_c_avv.lOr = aVar3.Avy.ry();
                    return 0;
                case 3:
                    com_tencent_mm_protocal_c_avv.lOs = aVar3.Avy.readString();
                    return 0;
                default:
                    return -1;
            }
