...
public final class a extends i<b> {
    public static final String[] gJN = new String[]{i.a(b.gJc, "MultiTalkInfo"), "CREATE INDEX IF NOT EXISTS idx_MultiTalkInfo_key  on MultiTalkInfo  (  wxGroupId )"};
    public static LinkedHashMap<String, Class> mGh = new 1();

    public final com.tencent.mm.au.b FE(java.lang.String r9) {
...
*/
    ...
    L_0x0034:
        r0 = new com.tencent.mm.au.b;	 Catch:{ Exception -> 0x00d9, all -> 0x00fb }
        ...
        r6 = java.lang.Integer.valueOf(r6);	 Catch:{ Exception -> 0x00d9, all -> 0x00fb }
        r4[r5] = r6;	 Catch:{ Exception -> 0x00d9, all -> 0x00fb }
        com.tencent.mm.sdk.platformtools.x.i(r2, r3, r4);	 Catch:{ Exception -> 0x00d9, all -> 0x00fb }
    ...
    L_0x00d9:
        ...
        r0 = r0.toString();	 Catch:{ Exception -> 0x00d9, all -> 0x00fb }
        com.tencent.mm.sdk.platformtools.x.e(r2, r0);	 Catch:{ Exception -> 0x00d9, all -> 0x00fb }
    ...
    L_0x0101:
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.mm.plugin.multitalk.b.a.FE(java.lang.String):com.tencent.mm.au.b");
    }

    public a(e eVar) {
        super(eVar, b.gJc, "MultiTalkInfo", null);
    }

    public final LinkedList<b> bcZ() {
    ...
    public final boolean a(b bVar) {
        ...
        x.i("MicroMsg.MultiTalk.storage.MultiTalkInfoStorage", "save. wxGroupId=%s, groupId=%s, roomId =%d, roomKey =%d, routeId =%d, inviteUser=%s,memberCount=%d,createTime=%d", new Object[]{str, bVar.field_groupId, Integer.valueOf(bVar.field_roomId), Long.valueOf(bVar.field_roomKey), Integer.valueOf(bVar.field_routeId), bVar.field_inviteUserName, Integer.valueOf(bVar.field_memberCount), Long.valueOf(bVar.field_createTime)});
        try {
            boolean b = b(bVar);
    ...
    public final boolean b(b bVar) {
        ...
        x.i("MicroMsg.MultiTalk.storage.MultiTalkInfoStorage", "update. wxGroupId=%s, groupId=%s, roomId =%d, roomKey =%d, routeId =%d, inviteUser=%s,memberCount=%d,createTime=%d,state=%d", new Object[]{str, bVar.field_groupId, Integer.valueOf(bVar.field_roomId), Long.valueOf(bVar.field_roomKey), Integer.valueOf(bVar.field_routeId), bVar.field_inviteUserName, Integer.valueOf(bVar.field_memberCount), Long.valueOf(bVar.field_createTime), Integer.valueOf(bVar.field_state)});
        try {
    ...
    public final boolean iF(String str) {
        ...
        try {
            super.fx("MultiTalkInfo", "delete from MultiTalkInfo where wxGroupId = \"" + str + "\"");
            return true;
        } catch (Exception e) {
