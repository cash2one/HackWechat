...
public final class byx extends a {
    ...
    protected final int a(int i, Object... objArr) {
        if (i == 0) {
            ...
            return ((e.a.a.b.b.a.dX(1) + 1) + 0) + e.a.a.a.c(2, 8, this.woc);
        } else {
            byte[] bArr;
            if (i == 2) {
                bArr = (byte[]) objArr[0];
                ...
                byx com_tencent_mm_protocal_c_byx = (byx) objArr[1];
                int intValue = ((Integer) objArr[2]).intValue();
                switch (intValue) {
                    case 1:
                        com_tencent_mm_protocal_c_byx.wYx = aVar3.cJC();
                        return 0;
                    case 2:
                        ...
                        for (intValue = 0; intValue < size; intValue++) {
                            ...
                            com_tencent_mm_protocal_c_byx.woc.add(com_tencent_mm_protocal_c_byq);
                        }
                        return 0;
                    default:
                        return -1;
