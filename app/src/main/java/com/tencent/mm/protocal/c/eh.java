...
public final class eh extends a {
    ...
    protected final int a(int i, Object... objArr) {
        if (i == 0) {
            ...
            if (this.vJF != null) {
                aVar.fW(2, this.vJF.bke());
                this.vJF.a(aVar);
            }
            if (this.vJG == null) {
                return 0;
            }
            aVar.fW(3, this.vJG.bke());
            this.vJG.a(aVar);
            return 0;
        } else if (i == 1) {
            if (this.vJF != null) {
                r0 = e.a.a.a.fT(2, this.vJF.bke()) + 0;
            } else {
                r0 = 0;
            }
            if (this.vJG != null) {
                r0 += e.a.a.a.fT(3, this.vJG.bke());
            }
            return r0;
        } else if (i == 2) {
            ...
            switch (intValue) {
                case 2:
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        ehVar.vJF = com_tencent_mm_protocal_c_bdn;
                    }
                    return 0;
                case 3:
                    Jl = aVar3.Jl(intValue);
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        ehVar.vJG = com_tencent_mm_protocal_c_bdn;
                    }
                    return 0;
                default:
                    return -1;
