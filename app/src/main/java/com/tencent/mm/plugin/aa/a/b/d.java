...
public final class d extends i<c> {
    public static final String[] gJN = new String[]{i.a(c.gJc, "AARecord")};
    private static final String[] ihe = new String[]{"*", "rowid"};
    public static Map<String, c> ihf = new HashMap();
    private e gJP;

    public final com.tencent.mm.plugin.aa.a.b.c oD(java.lang.String r10) {
...
*/
    ...
    L_0x005a:
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.mm.plugin.aa.a.b.d.oD(java.lang.String):com.tencent.mm.plugin.aa.a.b.c");
    }
    ...
    public d(e eVar) {
        super(eVar, c.gJc, "AARecord", null);
        this.gJP = eVar;
    }

    public final boolean a(c cVar) {
        if (cVar != null && ihf.containsKey(cVar.field_billNo)) {
            ihf.put(cVar.field_billNo, cVar);
        }
        return super.b(cVar);
    }
