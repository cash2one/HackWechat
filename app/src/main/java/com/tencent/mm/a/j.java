...
public final class j {
    private static void a(i iVar, i iVar2, i iVar3) {
        for (int i = 0; i < 8; i++) {
            iVar.fcL[iVar.fcM + i] = (byte) (iVar2.fcL[iVar2.fcM + i] ^ iVar3.fcL[iVar3.fcM + i]);
        }
    }
    ...
    private static void a(i iVar, i iVar2, int i) {
        for (int i2 = 0; i2 < i; i2++) {
            byte[] bArr = iVar.fcL;
            int i3 = iVar.fcM + i2;
            bArr[i3] = (byte) (bArr[i3] ^ iVar2.fcL[iVar2.fcM + i2]);
        }
    }

    private static void b(i iVar, i iVar2, int i) {
        for (int i2 = 0; i2 < i; i2++) {
            iVar.fcL[iVar.fcM + i2] = (byte) ((iVar2.fcL[(i2 >> 3) + iVar2.fcM] >> (i2 & 7)) & 1);
        }
    }
    ...
    private static void c(i iVar, i iVar2, int i) {
        ...
        for (int i3 = 0; i3 < 28 - i; i3++) {
            iVar.fcL[iVar.fcM + i3] = iVar.fcL[(iVar.fcM + i3) + i];
        }
        while (i2 < i) {
            iVar.fcL[((iVar.fcM + i2) + 28) - i] = iVar2.fcL[iVar2.fcM + i2];
            i2++;
        }
    }
    ...
    private static void a(i iVar, i iVar2, byte[] bArr, int i, i iVar3) {
        for (int i2 = 0; i2 < i; i2++) {
            iVar3.fcL[iVar3.fcM + i2] = iVar2.fcL[(iVar2.fcM + bArr[i2]) - 1];
        }
        d(iVar, iVar3, i);
    }
    ...
    private static void a(i iVar, i iVar2, i iVar3, i iVar4) {
        ...
        int i3 = iVar.fcM;
        while (i < 8) {
            byte b = (byte) ((((iVar3.fcL[iVar3.fcM + 1] << 3) + (iVar3.fcL[iVar3.fcM + 2] << 2)) + (iVar3.fcL[iVar3.fcM + 3] << 1)) + iVar3.fcL[iVar3.fcM + 4]);
            b(iVar, new i(r1[i][(byte) ((iVar3.fcL[iVar3.fcM + 0] << 1) + iVar3.fcL[iVar3.fcM + 5])][b]), 4);
            i = (byte) (i + 1);
            iVar3.fcM += 6;
            iVar.fcM += 4;
        }
    ...
    private static void a(i iVar, i iVar2, i[] iVarArr, int i, i iVar3, i iVar4, i iVar5, i iVar6, i iVar7, i iVar8) {
        ...
        for (i2 = 0; i2 < 64; i2++) {
            bArr2 = iVar.fcL;
            int i3 = iVar.fcM + (i2 >> 3);
            bArr2[i3] = (byte) (bArr2[i3] | (iVar3.fcL[iVar3.fcM + i2] << (i2 & 7)));
        }
    }
    ...
    public static char a(byte[] bArr, byte[] bArr2, long j, int i, byte[] bArr3, int i2) {
        ...
        if (bArr3 != null && bArr3.length > 0) {
            ...
            if (j2 != 0) {
                ...
                iVar7.fcL = iVar5.fcL;
                iVar8.fcM = 0;
                iVar8.fcL = iVar10.fcL;
                iVar9.fcM = 32;
                iVar9.fcL = iVar10.fcL;
                a(iVar4, 24);
                iVar5 = new i(bArr3);
                if (i > 24) {
                    i = 24;
    ...
    private static void d(i iVar, i iVar2, int i) {
        for (int i2 = 0; i2 < i; i2++) {
            iVar.fcL[iVar.fcM + i2] = iVar2.fcL[iVar2.fcM + i2];
        }
    }

    private static void a(i iVar, int i) {
        for (int i2 = 0; i2 < i; i2++) {
            iVar.fcL[iVar.fcM + i2] = (byte) 0;
        }
    }
}
