...
public final class a implements Creator<ConnectionEvent> {
    static void a(ConnectionEvent connectionEvent, Parcel parcel) {
        ...
        b.a(parcel, 2, connectionEvent.aPp);
        b.a(parcel, 4, connectionEvent.aPr);
        b.a(parcel, 5, connectionEvent.aPs);
        b.a(parcel, 6, connectionEvent.aPt);
        b.a(parcel, 7, connectionEvent.aPu);
        b.a(parcel, 8, connectionEvent.aPv);
        b.a(parcel, 10, connectionEvent.aPx);
        b.a(parcel, 11, connectionEvent.aPy);
        b.c(parcel, 12, connectionEvent.aPq);
        b.a(parcel, 13, connectionEvent.aPw);
        b.u(parcel, t);
    }
