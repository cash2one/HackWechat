...
public final class bnm extends bdf {
    public int wEk;
    public String wEl;
    public int wrA;
    public bdn wrx;
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        com_tencent_mm_protocal_c_bnm.wJr = feVar;
                    }
                    return 0;
                case 2:
                    Jl = aVar3.Jl(intValue);
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        com_tencent_mm_protocal_c_bnm.wrx = feVar;
                    }
                    return 0;
                case 3:
                    com_tencent_mm_protocal_c_bnm.wry = aVar3.Avy.ry();
                    return 0;
                case 4:
                    com_tencent_mm_protocal_c_bnm.wrz = aVar3.Avy.readString();
                    return 0;
                case 5:
                    com_tencent_mm_protocal_c_bnm.wrA = aVar3.Avy.ry();
                    return 0;
                case 6:
                    com_tencent_mm_protocal_c_bnm.wEk = aVar3.Avy.ry();
                    return 0;
                case 7:
                    com_tencent_mm_protocal_c_bnm.wEl = aVar3.Avy.readString();
                    return 0;
                default:
                    return -1;
            }
