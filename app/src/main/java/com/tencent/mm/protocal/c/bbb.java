...
public final class bbb extends bdf {
    public int id;
    public baw wHu;
    ...
    protected final int a(int i, Object... objArr) {
        if (i == 0) {
            ...
            if (this.wHu != null) {
                r0 += e.a.a.a.fT(2, this.wHu.bke());
            }
            if (this.wJr != null) {
                return r0 + e.a.a.a.fT(3, this.wJr.bke());
            }
            return r0;
        } else if (i == 2) {
            ...
            switch (intValue) {
                case 1:
                    com_tencent_mm_protocal_c_bbb.id = aVar3.Avy.ry();
                    return 0;
                case 2:
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        com_tencent_mm_protocal_c_bbb.wHu = com_tencent_mm_protocal_c_baw;
                    }
                    return 0;
                case 3:
                    Jl = aVar3.Jl(intValue);
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        com_tencent_mm_protocal_c_bbb.wJr = com_tencent_mm_protocal_c_baw;
                    }
                    return 0;
                default:
                    return -1;
