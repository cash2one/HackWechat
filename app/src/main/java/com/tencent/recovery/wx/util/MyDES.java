...
public class MyDES {
    private static void a(MyByteArray myByteArray, MyByteArray myByteArray2, int i) {
        for (int i2 = 0; i2 < i; i2++) {
            byte[] bArr = myByteArray.fcL;
            int i3 = myByteArray.fcM + i2;
            bArr[i3] = (byte) (bArr[i3] ^ myByteArray2.fcL[myByteArray2.fcM + i2]);
        }
    }

    private static void b(MyByteArray myByteArray, MyByteArray myByteArray2, int i) {
        for (int i2 = 0; i2 < i; i2++) {
            myByteArray.fcL[myByteArray.fcM + i2] = (byte) ((myByteArray2.fcL[(i2 >> 3) + myByteArray2.fcM] >> (i2 & 7)) & 1);
        }
    }
    ...
    private static void c(MyByteArray myByteArray, MyByteArray myByteArray2, int i) {
        ...
        for (int i3 = 0; i3 < 28 - i; i3++) {
            myByteArray.fcL[myByteArray.fcM + i3] = myByteArray.fcL[(myByteArray.fcM + i3) + i];
        }
        while (i2 < i) {
            myByteArray.fcL[((myByteArray.fcM + i2) + 28) - i] = myByteArray2.fcL[myByteArray2.fcM + i2];
            i2++;
        }
    }
    ...
    private static void a(MyByteArray myByteArray, MyByteArray myByteArray2, byte[] bArr, int i, MyByteArray myByteArray3) {
        for (int i2 = 0; i2 < i; i2++) {
            myByteArray3.fcL[myByteArray3.fcM + i2] = myByteArray2.fcL[(myByteArray2.fcM + bArr[i2]) - 1];
        }
    ...
    private static void a(MyByteArray myByteArray, MyByteArray myByteArray2, MyByteArray[] myByteArrayArr, int i, MyByteArray myByteArray3, MyByteArray myByteArray4, MyByteArray myByteArray5, MyByteArray myByteArray6, MyByteArray myByteArray7, MyByteArray myByteArray8) {
        ...
        for (i2 = 0; i2 < 16; i2++) {
            ...
            int i3 = myByteArray4.fcM;
            int i4 = myByteArray7.fcM;
            int i5 = 0;
            while (i5 < 8) {
                byte b = (byte) ((((myByteArray4.fcL[myByteArray4.fcM + 1] << 3) + (myByteArray4.fcL[myByteArray4.fcM + 2] << 2)) + (myByteArray4.fcL[myByteArray4.fcM + 3] << 1)) + myByteArray4.fcL[myByteArray4.fcM + 4]);
                MyByteArray myByteArray10 = myByteArray7;
                b(myByteArray10, new MyByteArray(r6[i5][(byte) ((myByteArray4.fcL[myByteArray4.fcM + 0] << 1) + myByteArray4.fcL[myByteArray4.fcM + 5])][b]), 4);
                i5 = (byte) (i5 + 1);
                myByteArray4.fcM += 6;
                myByteArray7.fcM += 4;
            }
        ...
        a(myByteArray, 8);
        for (i2 = 0; i2 < 64; i2++) {
            byte[] bArr4 = myByteArray.fcL;
            int i6 = myByteArray.fcM + (i2 >> 3);
            bArr4[i6] = (byte) (bArr4[i6] | (myByteArray3.fcL[myByteArray3.fcM + i2] << (i2 & 7)));
        }
    }
    ...
    public static char a(byte[] bArr, byte[] bArr2, long j, int i, byte[] bArr3) {
        ...
        if (bArr3 != null && bArr3.length > 0) {
            ...
            if (j2 != 0) {
                myByteArray6.fcM = 0;
                myByteArray6.fcL = myByteArray5.fcL;
                myByteArray7.fcM = 28;
                myByteArray7.fcL = myByteArray5.fcL;
                myByteArray8.fcM = 0;
                myByteArray8.fcL = myByteArray10.fcL;
                myByteArray9.fcM = 32;
                myByteArray9.fcL = myByteArray10.fcL;
                a(myByteArray4, 24);
                ...
                int i4 = myByteArray2.fcM;
                int i5 = myByteArray.fcM;
                ...
                while (j3 < j2) {
                    for (i2 = 0; i2 < 8; i2++) {
                        myByteArray14.fcL[myByteArray14.fcM + i2] = (byte) (myByteArray14.fcL[myByteArray14.fcM + i2] ^ myByteArray2.fcL[myByteArray2.fcM + i2]);
                    }
    ...
    private static void d(MyByteArray myByteArray, MyByteArray myByteArray2, int i) {
        for (int i2 = 0; i2 < i; i2++) {
            myByteArray.fcL[myByteArray.fcM + i2] = myByteArray2.fcL[myByteArray2.fcM + i2];
        }
    }

    private static void a(MyByteArray myByteArray, int i) {
        for (int i2 = 0; i2 < i; i2++) {
            myByteArray.fcL[myByteArray.fcM + i2] = (byte) 0;
        }
    }
}
