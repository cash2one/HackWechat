...
public final class bko extends bdf {
    public int vPq;
    public bdn vRA;
    public om vRD;
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        com_tencent_mm_protocal_c_bko.wJr = feVar;
                    }
                    return 0;
                case 2:
                    Jl = aVar3.Jl(intValue);
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        com_tencent_mm_protocal_c_bko.vRD = feVar;
                    }
                    return 0;
                case 3:
                    com_tencent_mm_protocal_c_bko.vPq = aVar3.Avy.ry();
                    return 0;
                case 4:
                    Jl = aVar3.Jl(intValue);
                    size = Jl.size();
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        com_tencent_mm_protocal_c_bko.vRA = feVar;
                    }
                    return 0;
                default:
                    return -1;
