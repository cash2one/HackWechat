...
public final class e extends a {
    ...
    public final void a(final d dVar, JSONObject jSONObject, final int i) {
        ...
        aPh.jwN = new MMActivity.a(this) {
            final /* synthetic */ e mWC;

            public final void b(int i, int i2, Intent intent) {
                if (i != (this.mWC.hashCode() & 65535)) {
                    return;
                }
                if (i2 == -1) {
                    d dVar = dVar;
                    int i3 = i;
                    e eVar = this.mWC;
                    dVar.E(i3, a.e("batch_view_card:ok", null));
                    return;
                }
                dVar = dVar;
                i3 = i;
                eVar = this.mWC;
                dVar.E(i3, a.e("batch_view_card:fail", null));
            }
        };
        com.tencent.mm.bm.d.a(aPh, "card", ".ui.CardViewEntranceUI", intent, hashCode() & 65535, false);
    }
}
