...
public final class bwc extends a {
    public bvh wXj;
    public int wXk;
    ...
    protected final int a(int i, Object... objArr) {
        if (i == 0) {
            ...
            return r0 + e.a.a.a.fR(2, this.wXk);
        } else if (i == 2) {
            ...
            bwc com_tencent_mm_protocal_c_bwc = (bwc) objArr[1];
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        com_tencent_mm_protocal_c_bwc.wXj = com_tencent_mm_protocal_c_bvh;
                    }
                    return 0;
                case 2:
                    com_tencent_mm_protocal_c_bwc.wXk = aVar3.Avy.ry();
                    return 0;
                default:
                    return -1;
            }
