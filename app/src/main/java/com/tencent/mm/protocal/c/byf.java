    ...
    protected final int a(int i, Object... objArr) {
        if (i == 0) {
            ...
            if (i == 2) {
                ...
                byf com_tencent_mm_protocal_c_byf = (byf) objArr[1];
                ...
                switch (intValue) {
                    case 1:
                        ...
                        for (intValue = 0; intValue < size; intValue++) {
                            ...
                            com_tencent_mm_protocal_c_byf.wkl.add(com_tencent_mm_protocal_c_bxy);
                        }
                        return 0;
                    case 2:
                        com_tencent_mm_protocal_c_byf.vNW = aVar3.Avy.ry();
                        return 0;
                    case 3:
                        com_tencent_mm_protocal_c_byf.wYx = aVar3.cJC();
                        return 0;
                    default:
                        return -1;
                }
