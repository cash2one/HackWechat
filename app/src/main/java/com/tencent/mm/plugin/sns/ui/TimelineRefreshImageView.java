...
public class TimelineRefreshImageView extends ImageView {
    ...
    public void buildDrawingCache(boolean z) {
        try {
            ...
            x.d("MicroMsg.TimelineRefreshImageView", ((Bitmap) declaredField.get(this)) == null ? "cache is null" : String.format("cache.width: %s, cache.height: %s, width: %s, height: %s", new Object[]{Integer.valueOf(((Bitmap) declaredField.get(this)).getWidth()), Integer.valueOf(((Bitmap) declaredField.get(this)).getHeight()), Integer.valueOf(getWidth()), Integer.valueOf(getHeight())}));
        } catch (Throwable e) {
            x.printErrStackTrace("MicroMsg.TimelineRefreshImageView", e, "", new Object[0]);
            x.e("MicroMsg.TimelineRefreshImageView", "checkIfCanReuseDrawingCache error: %s", new Object[]{e.getMessage()});
        }
        x.d("MicroMsg.TimelineRefreshImageView", "buildDrawingCache, autoScale: %s, width: %s, height: %s, hash: %s", new Object[]{Boolean.valueOf(z), Integer.valueOf(getWidth()), Integer.valueOf(getHeight()), Integer.valueOf(hashCode())});
