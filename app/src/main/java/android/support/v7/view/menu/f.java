...
public class f implements android.support.v4.c.a.a {
    ...
    public final void d(Bundle bundle) {
        if (bundle != null) {
            MenuItem item;
            SparseArray sparseParcelableArray = bundle.getSparseParcelableArray(dt());
            int size = size();
    ...
    private void a(List<h> list, int i, KeyEvent keyEvent) {
        ...
        if (keyEvent.getKeyData(keyData) || i == 67) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                char alphabeticShortcut = du ? hVar.getAlphabeticShortcut() : hVar.getNumericShortcut();
                if ((metaState & 5) == 0 && alphabeticShortcut != '\u0000' && ((alphabeticShortcut == keyData.meta[0] || alphabeticShortcut == keyData.meta[2] || (du && alphabeticShortcut == '\b' && i == 67)) && hVar.isEnabled())) {
                    list.add(hVar);
                }
            }
        }
    ...
    private h a(int i, KeyEvent keyEvent) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (du && alphabeticShortcut == '\b' && i == 67) {
                return hVar;
            }
        }
        return null;
    ...
    public final boolean a(MenuItem menuItem, l lVar, int i) {
        ...
        if (hVar.dL()) {
            expandActionView = hVar.expandActionView() | dE;
            if (!expandActionView) {
