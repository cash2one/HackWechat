...
public final class bq extends bcv {
    public String hvC;
    public String nhF;
    public int nhG;
        ...
        if (i == 0) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    return 0;
                case 2:
                    bqVar.nhF = aVar3.Avy.readString();
                    return 0;
                case 3:
                    bqVar.nic.add(aVar3.Avy.readString());
                    return 0;
                case 4:
                    bqVar.hvC = aVar3.Avy.readString();
                    return 0;
                case 5:
                    Jl = aVar3.Jl(intValue);
                    size = Jl.size();
                    ...
                    return 0;
                case 6:
                    bqVar.nie = aVar3.Avy.ry();
                    return 0;
                case 7:
                    bqVar.nif = aVar3.cJC();
                    return 0;
                case 8:
                    bqVar.nhG = aVar3.Avy.ry();
                    return 0;
                default:
                    return -1;
            }
