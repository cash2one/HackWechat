...
final class ActivityStubs {
    static final String AjT = ActivityStubs.class.getPackage().getName();
    static final String AjU = (AjT + "." + ActivityStubs.class.getSimpleName() + "$STDStub_%02X");
    static final String AjV = (AjT + "." + ActivityStubs.class.getSimpleName() + "$SGTStub_%02X");
    static final String AjW = (AjT + "." + ActivityStubs.class.getSimpleName() + "$SGTKStub_%02X");
    static final String AjX = (AjT + "." + ActivityStubs.class.getSimpleName() + "$SIStub_%02X");
