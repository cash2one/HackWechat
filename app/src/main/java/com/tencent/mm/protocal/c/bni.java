...
public final class bni extends a {
    ...
    protected final int a(int i, Object... objArr) {
        if (i == 0) {
            ...
            if (this.wQf != null) {
                return r0 + e.a.a.a.fT(2, this.wQf.bke());
            }
            return r0;
        } else if (i == 2) {
            ...
            switch (intValue) {
                case 1:
                    com_tencent_mm_protocal_c_bni.wuu = aVar3.Avy.ry();
                    return 0;
                case 2:
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        com_tencent_mm_protocal_c_bni.wQf = com_tencent_mm_protocal_c_bdo;
                    }
                    return 0;
                default:
                    return -1;
