...
public final class n {
    ...
    public static boolean bj(Context context) {
        ...
        if (context.getPackageManager().resolveActivity(new Intent("com.tencent.mm.gms.ACTION_CHOOSE_ACCOUNT"), 0) == null || context.getPackageManager().resolveActivity(intent, 0) == null || VERSION.SDK_INT < 8 || context.getSharedPreferences(ac.cfs(), 0).getBoolean("googleauth", false)) {
            return false;
        }
        return true;
    }
