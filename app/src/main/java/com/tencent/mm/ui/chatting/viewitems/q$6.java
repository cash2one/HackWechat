...
class q$6 implements OnClickListener {
    ...
    q$6(q qVar, String str, String str2, int i, int i2, String str3, String str4, int i3) {
        this.yLH = qVar;
        this.yLO = str;
        this.yJT = str2;
        this.yLP = i;
    ...
    public final void onClick(View view) {
        ...
        com.tencent.mm.plugin.report.service.g.pQN.h(11608, new Object[]{q.b(this.yLH), this.tIq, Integer.valueOf(this.hHw)});
    }
}
