...
public class GameClassifyView extends LinearLayout implements OnClickListener {
    ...
    protected void onFinishInflate() {
        ...
        this.nny = (LayoutInflater) this.mContext.getSystemService("layout_inflater");
    ...
    public final void a(ec ecVar, int i, int i2) {
        ...
        while (this.muI.getChildCount() < ecVar.ngS.size()) {
            LinearLayout linearLayout = (LinearLayout) this.nny.inflate(R.i.djR, this, false);
        ...
        setVisibility(0);
        if (i == 2) {
            ap.a(this.mContext, 10, 1019, 1, null, this.ndn, null);
        }
    }
    ...
    public void onClick(View view) {
        if (view.getTag() != null && (view.getTag() instanceof a)) {
            ...
            if (!bh.ov(aVar.url)) {
                ...
                ap.a(this.mContext, 10, 1019, aVar.position, 7, null, this.ndn, aVar.extInfo);
            }
        }
    }
}
