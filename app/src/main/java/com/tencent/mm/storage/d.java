...
public final class d extends i<c> {
    public static final String[] gJN = new String[]{i.a(c.gJc, "ABTestItem")};
    private final e gJP;

    public d(e eVar) {
        super(eVar, c.gJc, "ABTestItem", null);
        this.gJP = eVar;
    }
    ...
    public final Map<String, c> Wp(String str) {
        Cursor cursor;
        if (bh.ov(str)) {
            cursor = null;
        } else {
    ...
    public final void i(List<c> list, int i) {
        Object obj = null;
        long Wo = bh.Wo();
        this.gJP.delete("ABTestItem", String.format(Locale.US, "%s<>0 and %s<%d", new Object[]{"endTime", "endTime", Long.valueOf(Wo)}), null);
        if (i == 0) {
            c cVar = new c();
        ...
        for (c cVar2 : list) {
            boolean z;
            Object obj2;
            if (cVar2 == null || bh.ov(cVar2.field_layerId)) {
    ...
    public final LinkedList<tf> chG() {
        ...
        if (Tj != null && Tj.moveToFirst()) {
            ...
            do {
                ...
                tf tfVar = new tf();
                try {
                    tfVar.vYU = bh.getInt(cVar.field_expId, 0);
                } catch (Exception e) {
                    x.e("MicroMsg.ABTestStorage", "expId parse failed, %s", cVar.field_expId);
                }
                tfVar.priority = cVar.field_prioritylevel;
