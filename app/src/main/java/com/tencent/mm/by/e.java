...
public final class e extends AbstractCursor {
    ...
    public final int getInt(int i) {
        ...
        return bh.getInt(obj.toString(), 0);
    }
    ...
    public final long getLong(int i) {
        ...
        return bh.getLong(obj.toString(), 0);
    }
    ...
    public final float getFloat(int i) {
        ...
        return bh.getFloat(obj.toString(), 0.0f);
    }
    ...
    public final double getDouble(int i) {
        ...
        return bh.getDouble(obj.toString(), 0.0d);
    }
    ...
    private static int cf(Object obj) {
        if (obj == null) {
            return 0;
        }
