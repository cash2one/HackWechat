...
public final class f extends a {
    private static int qaf = 10;
    private final byte[] qae;
    ...
    public f(Bitmap bitmap, int i, int i2) {
        ...
        this.qae = new byte[(width * height)];
        for (int i3 = 0; i3 < height; i3++) {
            ...
            for (int i5 = 0; i5 < width; i5++) {
                ...
                i6 &= 255;
                if (i7 == i8 && i8 == i6) {
                    this.qae[i4 + i5] = (byte) i7;
                } else {
                    this.qae[i4 + i5] = (byte) ((i6 + ((i7 + i8) + i8)) >> 2);
                }
            }
        }
    }
    ...
    public final byte[] l(int i, byte[] bArr) {
        ...
        System.arraycopy(this.qae, i * i2, bArr, 0, i2);
        return bArr;
    }
