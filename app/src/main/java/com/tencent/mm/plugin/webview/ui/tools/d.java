...
public final class d {
    private static final HashMap<String, WeakReference<Bitmap>> txa = new HashMap();
    ...
    public static Bitmap Pd(String str) {
        WeakReference weakReference = (WeakReference) txa.get(str);
        ...
        if (decodeFile != null) {
            txa.put(str, new WeakReference(decodeFile));
            return decodeFile;
        }
        try {
            decodeFile = b.a(ac.getContext().getAssets().open("avatar/default_nor_avatar.png"), a.getDensity(null));
            txa.put(str, new WeakReference(decodeFile));
            return decodeFile;
        } catch (Throwable e) {
    ...
    public static Bitmap Pe(String str) {
        if (bh.ov(str)) {
            return null;
        }
        WeakReference weakReference = (WeakReference) txa.get(str);
        ...
        txa.put(str, new WeakReference(createScaledBitmap));
        return createScaledBitmap;
    }
