...
public final class bl extends bcv {
    public int kZx;
    ...
    protected final int a(int i, Object... objArr) {
        if (i == 0) {
            ...
            r0 += e.a.a.a.fR(5, this.vGH);
            if (this.vGI != null) {
                r0 += e.a.a.b.b.a.h(6, this.vGI);
            }
            return r0;
        } else if (i == 2) {
            r0 = (byte[]) objArr[0];
            ...
            switch (intValue) {
                ...
                case 4:
                    ...
                    return 0;
                case 5:
                    blVar.vGH = aVar3.Avy.ry();
                    return 0;
                case 6:
                    blVar.vGI = aVar3.Avy.readString();
                    return 0;
                default:
                    return -1;
            }
