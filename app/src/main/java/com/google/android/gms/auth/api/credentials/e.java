...
public final class e implements Creator<PasswordSpecification> {
    static void a(PasswordSpecification passwordSpecification, Parcel parcel) {
        ...
        b.a(parcel, 1, passwordSpecification.aIV);
        b.c(parcel, 1000, passwordSpecification.mVersionCode);
        b.a(parcel, 2, passwordSpecification.aIW);
        List list = passwordSpecification.aIX;
        if (list != null) {
            int t2 = b.t(parcel, 3);
            int size = list.size();
        ...
        b.c(parcel, 4, passwordSpecification.aIY);
        b.c(parcel, 5, passwordSpecification.aIZ);
        b.u(parcel, t);
    }
