...
public final class g {
    ...
    static class AnonymousClass1 implements d {
        final /* synthetic */ Application ffd;
        ...
        public final void a(aj ajVar, String str, Throwable th) {
            ...
            try {
                ...
                String H = c.gZN.H("last_login_uin", "0");
                ...
                intent.putExtra("INTENT_EXTRA_USER_NAME", c.gZN.H("login_user_name", "never_login_crash"));
                intent.putExtra("INTENT_EXTRA_EXCEPTION_MSG", Base64.encodeToString(stringBuilder.toString().getBytes(), 2));
                intent.putExtra("INTENT_EXTRA_DATA_PATH", a.gZK + "crash/");
                intent.putExtra("INTENT_EXTRA_SDCARD_PATH", a.gZM);
                intent.putExtra("INTENT_EXTRA_UIN", c.gZN.H("last_login_uin", "0"));
