...
public final class asn extends bdf {
    public int liH;
    public String liI;
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        com_tencent_mm_protocal_c_asn.wJr = feVar;
                    }
                    return 0;
                case 2:
                    com_tencent_mm_protocal_c_asn.liH = aVar3.Avy.ry();
                    return 0;
                case 3:
                    com_tencent_mm_protocal_c_asn.liI = aVar3.Avy.readString();
                    return 0;
                default:
                    return -1;
            }
