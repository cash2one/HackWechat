...
public final class b extends a {
    ...
    public final void a(e eVar) {
        ...
        if (this.e != 0 && this.d != 0) {
            ...
            c a = d$a.a(northeast);
            c a2 = d$a.a(southwest);
            double a3 = a.a() - a2.a();
            double b = a.b() - a2.b();
            a a4 = eVar.b().a(new a(0, (double) ((((float) this.e) * 1.0f) / ((float) this.d) < ((float) (a3 / b)) ? (float) ((((double) this.e) * 156543.0339d) / a3) : (float) ((((double) this.d) * 156543.0339d) / b))));
