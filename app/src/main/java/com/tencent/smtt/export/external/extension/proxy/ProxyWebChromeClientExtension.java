...
public class ProxyWebChromeClientExtension implements IX5WebChromeClientExtension {
    ...
    public void onHitTestResultFinished(IX5WebViewExtension iX5WebViewExtension, IX5WebViewBase$HitTestResult iX5WebViewBase$HitTestResult) {
        if (this.mWebChromeClient != null) {
            this.mWebChromeClient.onHitTestResultFinished(iX5WebViewExtension, iX5WebViewBase$HitTestResult);
        }
    }

    public void onHitTestResultForPluginFinished(IX5WebViewExtension iX5WebViewExtension, IX5WebViewBase$HitTestResult iX5WebViewBase$HitTestResult, Bundle bundle) {
        if (this.mWebChromeClient != null) {
            this.mWebChromeClient.onHitTestResultForPluginFinished(iX5WebViewExtension, iX5WebViewBase$HitTestResult, bundle);
        }
    }
