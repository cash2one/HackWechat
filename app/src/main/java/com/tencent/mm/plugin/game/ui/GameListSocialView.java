...
public class GameListSocialView extends LinearLayout {
    ...
    public final void H(LinkedList<String> linkedList) {
        ...
        if (getChildCount() < linkedList.size() / 2) {
            ...
            for (i = 0; i < size; i++) {
                inflate(getContext(), R.i.dkK, this);
            }
        }
        ...
        for (int i2 = 0; i2 < linkedList.size() / 2; i2++) {
            ...
            TextView textView = (TextView) childAt.findViewById(R.h.cnm);
            TextView textView2 = (TextView) childAt.findViewById(R.h.cnn);
            textView.setText(i.b(getContext(), (CharSequence) linkedList.get(i2 * 2), textView.getTextSize()));
            textView2.setText(i.b(getContext(), (CharSequence) linkedList.get((i2 * 2) + 1), textView2.getTextSize()));
        }
    }
}
