...
public final class a {
    private static final Map<String, Class<? extends AppBrandTaskProxyUI>> jaF;
    ...
    public static <_Req extends ProcessRequest, _Result extends AppBrandProxyUIProcessTask$ProcessResult> void a(Context context, _Req _Req, b<_Result> bVar) {
        AppBrandProcessProxyUI.a(context, AppBrandProcessProxyUI.class, _Req, bVar);
    }

    public static <_Req extends ProcessRequest, _Result extends AppBrandProxyUIProcessTask$ProcessResult> void b(Context context, _Req _Req, b<_Result> bVar) {
        Class cls = (Class) jaF.get(ac.Br().replaceFirst(ac.getPackageName(), ""));
    ...
    static {
        ...
        jaF = Collections.unmodifiableMap(hashMap);
    }
}
