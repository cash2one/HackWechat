...
class SimpleLoginUI$12 extends c<iy> {
    ...
    public final /* synthetic */ boolean a(b bVar) {
        ...
        x.i("MicroMsg.SimpleLoginUI", "summerdiz loginDisasterListener callback content[%s], url[%s]", new Object[]{iyVar.fzB.content, iyVar.fzB.url});
