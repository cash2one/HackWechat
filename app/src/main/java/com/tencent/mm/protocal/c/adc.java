...
public final class adc extends bdf {
    public String wly;
    public String wlz;
            ...
            switch (intValue) {
                case 1:
                    ...
                    for (intValue = 0; intValue < size; intValue++) {
                        ...
                        com_tencent_mm_protocal_c_adc.wJr = feVar;
                    }
                    return 0;
                case 2:
                    com_tencent_mm_protocal_c_adc.wly = aVar3.Avy.readString();
                    return 0;
                case 3:
                    com_tencent_mm_protocal_c_adc.wlz = aVar3.Avy.readString();
                    return 0;
                default:
                    return -1;
            }
