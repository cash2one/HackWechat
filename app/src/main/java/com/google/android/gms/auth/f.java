...
public final class f implements Creator<AccountChangeEventsRequest> {
    static void a(AccountChangeEventsRequest accountChangeEventsRequest, Parcel parcel, int i) {
        ...
        b.c(parcel, 1, accountChangeEventsRequest.aIt);
        b.c(parcel, 2, accountChangeEventsRequest.aIx);
        b.a(parcel, 3, accountChangeEventsRequest.aIv);
        b.a(parcel, 4, accountChangeEventsRequest.aIz, i);
        b.u(parcel, t);
    }
