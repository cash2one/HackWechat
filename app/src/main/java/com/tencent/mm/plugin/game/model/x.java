...
public final class x extends i<t> {
    public static final String[] gJN = new String[]{i.a(t.gJc, "GameRawMessage")};

    public x(e eVar) {
        super(eVar, t.gJc, "GameRawMessage", null);
    }

    public final t dv(long j) {
        c tVar = new t();
        tVar.field_msgId = j;
    ...
    public final boolean e(long[] jArr) {
        ...
        return fx("GameRawMessage", String.format("update GameRawMessage set isRead=1 where %s", new Object[]{stringBuilder2}));
    }

    public final void aQv() {
        fx("GameRawMessage", "update GameRawMessage set isHidden = 0 where isHidden = 1");
    }

    public final void aQw() {
        String str = "GameRawMessage";
        fx(str, "update GameRawMessage set isRead=1 where isRead=0 and " + j(2, 5, 6, 10, 11, 100) + " and isHidden = 0");
    }
