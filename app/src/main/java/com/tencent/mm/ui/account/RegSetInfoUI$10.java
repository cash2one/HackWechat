...
class RegSetInfoUI$10 implements Runnable {
    ...
    RegSetInfoUI$10(RegSetInfoUI regSetInfoUI, k kVar, String str, String str2, boolean z, String str3, String str4, int i) {
    ...
    public final void run() {
        ...
        if (this.xSh == null || !this.xSh.contains("0")) {
            ...
            b.oI(ar.CB() + "," + this.xSg.getClass().getName() + ",R200_900_phone," + ar.fH("R200_900_phone") + ",4");
            this.xSg.finish();
            return;
        }
        b.oH("R300_100_phone");
