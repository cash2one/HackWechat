...
class LoginIndepPass$1 extends c<iy> {
    final /* synthetic */ LoginIndepPass xPi;

    LoginIndepPass$1(LoginIndepPass loginIndepPass) {
    ...
    public final /* synthetic */ boolean a(b bVar) {
        ...
        x.i("MicroMsg.LoginIndepPass", "summerdiz loginDisasterListener callback content[%s], url[%s]", new Object[]{iyVar.fzB.content, iyVar.fzB.url});
