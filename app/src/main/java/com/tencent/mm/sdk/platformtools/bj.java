...
final class bj {
    ...
    private static void a(int[] iArr, String str, XmlSerializer xmlSerializer) {
        ...
        for (int num : iArr) {
            ...
            xmlSerializer.attribute(null, DownloadSettingTable$Columns.VALUE, Integer.toString(num));
    ...
    private static void a(Object obj, String str, XmlSerializer xmlSerializer) {
        if (obj == null) {
            ...
            xmlSerializer.attribute(null, DownloadSettingTable$Columns.VALUE, obj.toString());
            ...
            do {
                if (eventType == 2) {
                    if (xmlPullParser.getName().equals("item")) {
                        try {
                            iArr[i] = Integer.parseInt(xmlPullParser.getAttributeValue(null, DownloadSettingTable$Columns.VALUE));
    ...
    private static final Object b(XmlPullParser xmlPullParser, String[] strArr) {
        ...
        if (!name.equals("null")) {
            if (name.equals("string")) {
                ...
                obj = Integer.valueOf(Integer.parseInt(xmlPullParser.getAttributeValue(null, DownloadSettingTable$Columns.VALUE)));
            } else if (name.equals("long")) {
                obj = Long.valueOf(xmlPullParser.getAttributeValue(null, DownloadSettingTable$Columns.VALUE));
            } else if (name.equals("float")) {
                obj = Float.valueOf(xmlPullParser.getAttributeValue(null, DownloadSettingTable$Columns.VALUE));
            } else if (name.equals("double")) {
                obj = Double.valueOf(xmlPullParser.getAttributeValue(null, DownloadSettingTable$Columns.VALUE));
            } else if (name.equals(DownloadSetting.TYPE_BOOLEAN)) {
                obj = Boolean.valueOf(xmlPullParser.getAttributeValue(null, DownloadSettingTable$Columns.VALUE));
