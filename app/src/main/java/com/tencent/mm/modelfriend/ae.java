...
public final class ae extends m {
    ...
    public final Cursor r(int i, boolean z) {
        ...
        return this.hhp.a(str, strArr, 0);
    }
    ...
    public final int a(long j, ad adVar) {
        int i = 0;
        ContentValues Ou = adVar.Ou();
        if (Ou.size() > 0) {
            i = this.hhp.update("qqlist", Ou, "qq=?", new String[]{String.valueOf(j)});
        }
        if (i > 0) {
    ...
    public final boolean a(ad adVar) {
        ...
        x.d("MicroMsg.QQListStorage", "insert: name:" + adVar.Ov());
        adVar.fDt = -1;
        if (((int) this.hhp.insert("qqlist", "qq", adVar.Ou())) == -1) {
            return false;
        }
        b(2, this, adVar.hwR);
        return true;
    ...
    public final boolean hH(int i) {
        ...
        Cursor cursor = null;
        try {
            cursor = this.hhp.a("select reserved3 from qqlist where groupid=? and reserved3=?  limit 1", new String[]{String.valueOf(i), "0"}, 2);
