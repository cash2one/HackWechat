...
class AndroidNClassLoader extends PathClassLoader {
    private final PathClassLoader Ajj;
    private String Ajk;
    ...
    public Class<?> findClass(String str) {
        if ((str == null || !str.startsWith("com.tencent.tinker.loader.") || str.equals("com.tencent.tinker.loader.TinkerTestDexLoad")) && (this.Ajk == null || !this.Ajk.equals(str))) {
            return super.findClass(str);
        }
        return this.Ajj.loadClass(str);
    }
