...
public class QbarNative {
    public static QbarPossibleInfo zQF = new QbarPossibleInfo(null);
    public byte[] data = new byte[3000];
    public byte[] type = new byte[100];
    public byte[] zQG = new byte[100];
    public int[] zQH = new int[4];
    public byte[] zQI = new byte[300];
    public int[] zQJ = new int[2];
    public int zQK = -1;
    ...
    public final int t(byte[] bArr, int i, int i2) {
        return ScanImage(bArr, i, i2, 0, this.zQK);
    }
    ...
    public final int a(StringBuilder stringBuilder, StringBuilder stringBuilder2, StringBuilder stringBuilder3, StringBuilder stringBuilder4, int[] iArr) {
        int GetOneResultReport = GetOneResultReport(this.type, this.data, this.zQG, this.zQI, this.zQJ, this.zQH, this.zQK);
        try {
            iArr[0] = this.zQJ[0];
            iArr[1] = this.zQJ[1];
            String str = new String(this.zQG, 0, this.zQH[2], "UTF-8");
            stringBuilder3.append(str);
            if (str.equals("ANY")) {
                stringBuilder.append(new String(this.type, 0, this.zQH[0], "UTF-8"));
                stringBuilder2.append(new String(this.data, 0, this.zQH[1], "UTF-8"));
                stringBuilder4.append(new String(this.zQI, 0, this.zQH[3], "UTF-8"));
                if (stringBuilder2.length() == 0) {
                    stringBuilder.append(new String(this.type, 0, this.zQH[0], "ASCII"));
                    stringBuilder2.append(new String(this.data, 0, this.zQH[1], "ASCII"));
                    stringBuilder4.append(new String(this.zQI, 0, this.zQH[3], "ASCII"));
                }
            } else {
                stringBuilder.append(new String(this.type, 0, this.zQH[0], str));
                stringBuilder2.append(new String(this.data, 0, this.zQH[1], str));
                stringBuilder4.append(new String(this.zQI, 0, this.zQH[3], str));
            }
        } catch (Throwable e) {
