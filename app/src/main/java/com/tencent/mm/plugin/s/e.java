...
public final class e {
    ...
    public static String aZD() {
        x.d("MicroMsg.MediaCodecUtil", "check hevc info last rpt time[%d]", new Object[]{Long.valueOf(opl)});
        try {
            opl = bh.Wp();
            if (!d.fM(21)) {
                return aZE();
            ...
            x.i("MicroMsg.MediaCodecUtil", "high api 21 cost[%d] hevc info %s", new Object[]{Long.valueOf(bh.bA(Wq)), stringBuilder3.toString()});
    ...
    private static String aZE() {
        ...
        x.i("MicroMsg.MediaCodecUtil", "below api 21 cost[%d] hevc info %s", new Object[]{Long.valueOf(bh.bA(Wq)), stringBuilder3.toString()});
        return stringBuilder3.toString();
    }
    ...
    private static String a(MediaCodecInfo mediaCodecInfo) {
        ...
        for (String str : supportedTypes) {
            if (!bh.ov(str) && str.contains("hevc")) {
                return str;
            }
        }
        return "";
