                    ...
                    try {
                        ...
                        if (decodeByteArray != null) {
                            try {
                                ...
                                if (a.length < 2097152) {
                                    try {
                                        a.a().a(new c(a, this.c.l()), this.c);
                                        bitmap = decodeByteArray;
                                    } catch (Throwable th) {
                                        if (g.Aed != null) {
                                            g.Aed.collectErrorInfo("TileNetFetcher downLoad function occured exception when call CacheManager Put,the downloaded data length-" + a.length + ";tileInfo:x=" + this.c.b() + ",y=" + this.c.c() + "z=" + this.c.d() + "exceptionInfo:" + th.toString());
                                        }
                                        bitmap = decodeByteArray;
                                    }
                                } else if (g.Aed != null) {
                                    g.Aed.collectErrorInfo("TileNetFetcher downLoad function,the downloaded data length-" + a.length + ";tileInfo:x=" + this.c.b() + ",y=" + this.c.c() + "z=" + this.c.d());
                                }
                            } catch (Exception e2) {
                                e = e2;
                                try {
