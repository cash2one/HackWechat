...
public final class e {
    ...
    public static Bundle ZL(String str) {
        try {
    ...
    public static String e(String str, String str2, Bundle bundle) {
        ...
        try {
            return s(httpURLConnection.getInputStream());
        } catch (FileNotFoundException e) {
            return s(httpURLConnection.getErrorStream());
        }
    }
    ...
    public static JSONObject ZM(String str) {
        ...
        if (jSONObject.has("error")) {
            ...
            throw new d(jSONObject.getString("message"), jSONObject.getString(DownloadSettingTable$Columns.TYPE), 0);
