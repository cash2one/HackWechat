...
class MP3Header {
    ...
    MP3Header() {
        r0 = new int[2][][];
        r0[0] = new int[][]{new int[]{0, 32, 64, 96, FileUtils.S_IWUSR, JsApiSetBackgroundAudioState.CTRL_INDEX, ar.CTRL_INDEX, 224, 256, 288, 320, d.CTRL_INDEX, 384, 416, FileUtils.S_IRWXU}, new int[]{0, 32, 48, 56, 64, 80, 96, MMGIFException.D_GIF_ERR_IMAGE_DEFECT, FileUtils.S_IWUSR, JsApiSetBackgroundAudioState.CTRL_INDEX, ar.CTRL_INDEX, 224, 256, 320, 384}, new int[]{0, 32, 40, 48, 56, 64, 80, 96, MMGIFException.D_GIF_ERR_IMAGE_DEFECT, FileUtils.S_IWUSR, JsApiSetBackgroundAudioState.CTRL_INDEX, ar.CTRL_INDEX, 224, 256, 320}};
        r0[1] = new int[][]{new int[]{0, 32, 48, 56, 64, 80, 96, MMGIFException.D_GIF_ERR_IMAGE_DEFECT, FileUtils.S_IWUSR, e.CTRL_INDEX, JsApiSetBackgroundAudioState.CTRL_INDEX, 176, ar.CTRL_INDEX, 224, 256}, new int[]{0, 8, 16, 24, 32, 40, 48, 56, 64, 80, 96, MMGIFException.D_GIF_ERR_IMAGE_DEFECT, FileUtils.S_IWUSR, e.CTRL_INDEX, JsApiSetBackgroundAudioState.CTRL_INDEX}, new int[]{0, 8, 16, 24, 32, 40, 48, 56, 64, 80, 96, MMGIFException.D_GIF_ERR_IMAGE_DEFECT, FileUtils.S_IWUSR, e.CTRL_INDEX, JsApiSetBackgroundAudioState.CTRL_INDEX}};
        this.bitrate = r0;
    }
