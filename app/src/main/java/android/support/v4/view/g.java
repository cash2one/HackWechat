...
public final class g {
    ...
    static class a implements d {
        ...
        public int normalizeMetaState(int i) {
            ...
            return i2 & an.CTRL_INDEX;
        }

        public boolean metaStateHasModifiers(int i, int i2) {
            if (c(c(normalizeMetaState(i) & an.CTRL_INDEX, i2, 1, 64, FileUtils.S_IWUSR), i2, 2, 16, 32) == i2) {
                return true;
            }
            return false;
        }
        ...
        public boolean metaStateHasNoModifiers(int i) {
            return (normalizeMetaState(i) & an.CTRL_INDEX) == 0;
        }
    ...
    public static boolean a(KeyEvent keyEvent, int i) {
        return xl.metaStateHasModifiers(keyEvent.getMetaState(), i);
    }

    public static boolean a(KeyEvent keyEvent) {
        return xl.metaStateHasNoModifiers(keyEvent.getMetaState());
    }
