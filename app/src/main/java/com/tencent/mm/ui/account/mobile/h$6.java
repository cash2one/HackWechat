...
class h$6 implements Runnable {
    ...
    h$6(h hVar, k kVar, String str, String str2, boolean z, String str3, String str4, int i) {
        this.xUN = hVar;
        this.flZ = kVar;
        this.xQX = str;
        this.xSh = str2;
    ...
    public final void run() {
        ...
        if (this.xSh == null || !this.xSh.contains("0")) {
            ...
            b.oI(ar.CB() + "," + this.xUN.xUE.getClass().getName() + ",R200_900_phone," + ar.fH("R200_900_phone") + ",4");
            this.xUN.xUE.finish();
            return;
        }
        b.oH("R300_100_phone");
