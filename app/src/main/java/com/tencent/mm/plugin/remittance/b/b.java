...
public final class b extends i<a> {
    public static final String[] gJN = new String[]{i.a(a.gJc, "DelayTransferRecord")};
    private static final String[] ihe = new String[]{"*", "rowid"};
    private e gJP;

    public final com.tencent.mm.plugin.remittance.b.a Io(java.lang.String r10) {
...
*/
    ...
    L_0x0043:
        ...
        com.tencent.mm.sdk.platformtools.x.printErrStackTrace(r2, r0, r3, r4);	 Catch:{ Exception -> 0x0043, all -> 0x0056 }
        if (r1 == 0) goto L_0x0011;
    L_0x0052:
        r1.close();
        goto L_0x0011;
    ...
    L_0x005c:
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.mm.plugin.remittance.b.b.Io(java.lang.String):com.tencent.mm.plugin.remittance.b.a");
    }

    public b(e eVar) {
        super(eVar, a.gJc, "DelayTransferRecord", null);
        this.gJP = eVar;
    }
}
