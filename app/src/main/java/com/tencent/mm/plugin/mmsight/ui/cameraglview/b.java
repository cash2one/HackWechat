...
public final class b implements Renderer {
    ...
    public final void b(byte[] bArr, int i, int i2, int i3, boolean z) {
        try {
            int i4;
            if (this.ioE == i2 && this.ioD == i && this.fFy == i3 && this.ioU == z) {
                i4 = 0;
            } else {
                i4 = 1;
            }
            ...
            this.ioU = z;
            if (i4 != 0) {
                this.ioF = ByteBuffer.allocateDirect(i2 * i);
                this.ioG = ByteBuffer.allocateDirect((i * i2) / 2);
                this.ioF.order(ByteOrder.nativeOrder());
                this.ioG.order(ByteOrder.nativeOrder());
                if (z) {
                    this.ioT = iox;
                } else {
                    this.ioT = iow;
            ...
            if (this.ioF != null && this.ioG != null) {
                this.ioF.put(bArr, 0, i * i2);
                this.ioF.position(0);
                this.ioG.put(bArr, i * i2, (i * i2) / 2);
                this.ioG.position(0);
            }
        } catch (Exception e) {
    ...
    public final void onSurfaceCreated(GL10 gl10, EGLConfig eGLConfig) {
        ...
        this.ioJ = com.tencent.mm.plugin.api.recordView.b.aI("attribute vec4 a_position;                         \nattribute vec2 a_texCoord;                         \nvarying vec2 v_texCoord;                           \nuniform mat4 uMatrix;                              \nvoid main() {                                      \n   gl_Position = uMatrix * a_position;             \n   v_texCoord = a_texCoord;                        \n}                                                  \n", "#ifdef GL_ES                                       \nprecision highp float;                             \n#endif                                             \nvarying vec2 v_texCoord;                           \nuniform sampler2D y_texture;                       \nuniform sampler2D uv_texture;                      \nvoid main (void) {                                 \n   float r, g, b, y, u, v;                         \n   y = texture2D(y_texture, v_texCoord).r;         \n   u = texture2D(uv_texture, v_texCoord).a;        \n   v = texture2D(uv_texture, v_texCoord).r;        \n   u = u - 0.5;                                    \n   v = v - 0.5;                                    \n   r = y + 1.370705 * v;                           \n   g = y - 0.337633 * u - 0.698001 * v;            \n   b = y + 1.732446 * u;                           \n   gl_FragColor = vec4(r, g, b, 1.0);              \n}                                                  \n");
        if (this.ioJ == 0) {
        ...
        this.ioH = com.tencent.mm.plugin.api.recordView.b.XZ();
        this.ioI = com.tencent.mm.plugin.api.recordView.b.XZ();
