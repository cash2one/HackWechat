...
public final class aa implements Creator<MessageEventParcelable> {
    static void a(MessageEventParcelable messageEventParcelable, Parcel parcel) {
        ...
        b.c(parcel, 2, messageEventParcelable.beG);
        b.a(parcel, 3, messageEventParcelable.beo);
        b.a(parcel, 4, messageEventParcelable.bdg);
        b.a(parcel, 5, messageEventParcelable.aYx);
        b.u(parcel, t);
    }
