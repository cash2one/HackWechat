...
public final class c implements Creator<FieldMappingDictionary> {
    static void a(FieldMappingDictionary fieldMappingDictionary, Parcel parcel) {
        ...
        for (String str : fieldMappingDictionary.aPg.keySet()) {
            arrayList.add(new Entry(str, (Map) fieldMappingDictionary.aPg.get(str)));
        }
        b.b(parcel, 2, arrayList);
        b.a(parcel, 3, fieldMappingDictionary.aPi);
        b.u(parcel, t);
    }
