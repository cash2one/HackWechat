...
public final class c {
    ...
    public c(e eVar, MarkerOptions markerOptions) {
        ...
        this.k = new GestureDetector(this.d, new OnGestureListener(this) {
            ...
            public final boolean onSingleTapUp(MotionEvent motionEvent) {
                this.a.n();
                if (this.a.e.d() != null) {
                    return this.a.e.d().b(new Marker(this.a));
                }
                if (this.a.e()) {
                    this.a.g();
                } else {
    ...
    private MapView$a s() {
        PointF t = t();
        return new MapView$a(-2, -2, this.w, -((int) t.x), -((int) t.y), 0);
    }
    ...
    private void v() {
        if (e()) {
            ...
            PointF u = u();
            this.f.addView(this.h, this.f.indexOfChild(this.g) + 1, new MapView$a(-2, -2, this.w, (int) u.x, (int) u.y, 81));
        }
    }
    ...
    public final void a(LatLng latLng) {
        this.w = latLng;
        ((MapView$a) this.g.getLayoutParams()).point = latLng;
        this.f.layout(this.g);
        if (this.h != null) {
            ((MapView$a) this.h.getLayoutParams()).point = latLng;
    ...
    public final void f() {
        if (!e()) {
            Animation animation;
            if (this.e.g() != null) {
                View c = this.e.g().c(new Marker(this));
                if (c == null) {
