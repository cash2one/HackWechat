...
public final class h extends a {
    ...
    protected final int a(int i, Object... objArr) {
        if (i == 0) {
            ...
            return ((r0 + e.a.a.a.fR(6, this.vCh)) + e.a.a.a.fR(7, this.vCw)) + e.a.a.a.fR(8, this.vCi);
        } else if (i == 2) {
            ...
            switch (intValue) {
                case 1:
                    hVar.ret = aVar3.Avy.ry();
                    return 0;
                case 2:
                    hVar.vCd = aVar3.Avy.ry();
                    return 0;
                case 3:
                    hVar.vCe = aVar3.Avy.ry();
                    return 0;
                case 4:
                ...
                case 5:
                    ...
                    return 0;
                case 6:
                    hVar.vCh = aVar3.Avy.ry();
                    return 0;
                case 7:
                    hVar.vCw = aVar3.Avy.ry();
                    return 0;
                case 8:
                    hVar.vCi = aVar3.Avy.ry();
                    return 0;
                default:
                    return -1;
            }
