...
public class af implements com.tencent.mm.sdk.platformtools.ah.a {
    private static final String TAG = "MicroMsg.MMHandler";
    private static b sLogCallback;
    private ah handler;
    private int latestSize;
    private LinkedList<WeakReference<al>> latestTasks;
    private ConcurrentHashMap<Runnable, WeakReference<al>> map;
    ...
    public af() {
        ...
        if (getLooper().getThread().getName().equals("initThread")) {
            x.e(TAG, "MMHandler can not init handler with initThread looper, stack %s", bh.cgy());
        }
    }
    ...
    public af(Looper looper) {
        ...
        this.latestTasks = new LinkedList();
        this.toStringResult = null;
        this.handler = new ah(looper, (com.tencent.mm.sdk.platformtools.ah.a) this);
    ...
    public af(a aVar) {
        ...
        this.latestTasks = new LinkedList();
        this.toStringResult = null;
        this.handler = new ah((Callback) aVar, (com.tencent.mm.sdk.platformtools.ah.a) this);
        if (getLooper().getThread().getName().equals("initThread")) {
            x.e(TAG, "MMHandler can not init handler with initThread looper, stack %s", bh.cgy());
        }
    }

    public af(Looper looper, a aVar) {
        this.map = new ConcurrentHashMap();
        this.latestTasks = new LinkedList();
        this.toStringResult = null;
    ...
    public final void removeCallbacks(Runnable runnable, Object obj) {
        if (runnable != null) {
            WeakReference weakReference = (WeakReference) this.map.get(runnable);
            if (!(weakReference == null || weakReference.get() == null || (obj != null && ((al) weakReference.get()).xfW != obj))) {
        ...
        if (it != null) {
            while (it.hasNext()) {
                ...
                if (entry != null) {
                    ...
                    if (!(weakReference == null || weakReference.get() == null || ((al) weakReference.get()).xfW != obj)) {
                        it.remove();
                    }
                }
            }
    ...
    public final void onTaskAdded(Runnable runnable, al alVar) {
        this.map.put(runnable, new WeakReference(alVar));
    }

    public final void onTaskRunEnd(Runnable runnable, al alVar) {
        WeakReference weakReference = (WeakReference) this.map.get(runnable);
        if (weakReference != null && weakReference.get() != null && weakReference.get() == alVar) {
            this.map.remove(runnable);
    ...
    public String dumpLatestTasks(boolean z) {
        ...
        if (it != null) {
            ...
            while (it.hasNext()) {
                ...
                if (!(weakReference == null || weakReference.get() == null)) {
                    stringBuilder.append("[index = " + i + "|task=" + ((al) weakReference.get()).dump(z) + "]");
                }
                i++;
            }
        }
    ...
    public String dump(boolean z) {
        ...
        if (it != null) {
            ...
            while (it.hasNext()) {
                WeakReference weakReference = (WeakReference) it.next();
                if (!(weakReference == null || weakReference.get() == null)) {
                    stringBuilder.append("[index = " + i + " | taskinfo:" + ((al) weakReference.get()).dump(z) + "]\n");
                }
                i++;
            }
        }
    ...
    public static String dump(Runnable runnable, boolean z) {
        ...
        if (runnable instanceof al) {
            return ((al) runnable).dump(z);
        }
        ...
        if (it != null) {
            while (it.hasNext()) {
                ...
                if (!(weakReference == null || weakReference.get() == null)) {
                    ...
                    if (alVar.started && alVar.hjb >= alVar.xfY && currentTimeMillis - alVar.hjb > j) {
                        x.i(TAG, "findTaskByRunTime limit: %d, found task info: %s", Long.valueOf(j), alVar.dump(true));
                        return alVar;
                    }
                }
            }
    ...
    public Runnable findTaskByName(String str) {
        ...
        if (it != null) {
            while (it.hasNext()) {
                ...
                if (!(weakReference == null || weakReference.get() == null)) {
                    al alVar = (al) weakReference.get();
                    if (alVar.mWn.equals(str)) {
                        x.i(TAG, "findTaskByName: %s, found task info: %s", str, alVar.dump(true));
                        return alVar;
                    }
                }
            }
