...
public class DownloadSettingTable implements ITableBase {
        ...
        if (str != null && str2 != null) {
            try {
                ...
                if (update(str, str2, str3, writableDatabase) <= 0) {
                    ...
                    contentValues.put(DownloadSettingTable$Columns.SETTINGFIELD, str);
                    contentValues.put(DownloadSettingTable$Columns.VALUE, str2);
                    contentValues.put(DownloadSettingTable$Columns.TYPE, str3);
    ...
    public static HashMap<String, String> query() {
        ...
        try {
            ...
            do {
                hashMap.put(cursor.getString(cursor.getColumnIndex(DownloadSettingTable$Columns.SETTINGFIELD)), cursor.getString(cursor.getColumnIndex(DownloadSettingTable$Columns.VALUE)));
