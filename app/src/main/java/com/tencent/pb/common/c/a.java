        ...
        if (file.length() != 0) {
            ...
            if (new File(file + str).exists()) {
                try {
                    ...
                    f.w(f.CTRL_INDEX, 3, "case1:" + file + str);
                    c.m("loadLibrary", new Object[]{"cannot load library " + file + str});
                }
                if (lastIndexOf == 0 || str.endsWith(".so")) {
                    ...
                    if (new File(file + str2).exists()) {
                        try {
                            ...
                            c.m("loadLibrary", new Object[]{"cannot load library " + file + str2});
                            f.w(f.CTRL_INDEX, 3, "case2:" + file + str2);
                        }
                    }
                }
                if (lastIndexOf == 0 && !str2.startsWith("lib")) {
                    ...
                    if (new File(file + str2).exists()) {
                        try {
                            ...
                            c.m("loadLibrary", new Object[]{"cannot load library " + file + str2});
                            f.w(f.CTRL_INDEX, 3, "case3:" + file + str2);
                        }
                        if (i == 0) {
                            try {
                                ...
                                c.m("loadLibrary", new Object[]{"cannot load library " + str});
                                f.w(f.CTRL_INDEX, 3, "case4:" + str);
                                return false;
                            }
                        }
                    }
