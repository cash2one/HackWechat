...
public final class cb extends a {
    public String fon;
    public LinkedList<cc> niQ = new LinkedList();
    public String niR;
    public String niS;
    ...
    protected final int a(int i, Object... objArr) {
        if (i == 0) {
            ...
            switch (intValue) {
                case 1:
                    cbVar.fon = aVar3.Avy.readString();
                    return 0;
                case 2:
                    ...
                    return 0;
                case 3:
                    cbVar.niR = aVar3.Avy.readString();
                    return 0;
                case 4:
                    cbVar.niS = aVar3.Avy.readString();
                    return 0;
                default:
                    return -1;
            }
