...
public final class g implements Creator<WakeLockEvent> {
    static void a(WakeLockEvent wakeLockEvent, Parcel parcel) {
        ...
        b.a(parcel, 2, wakeLockEvent.aPp);
        b.a(parcel, 4, wakeLockEvent.aPA);
        b.c(parcel, 5, wakeLockEvent.aPB);
        b.a(parcel, 6, wakeLockEvent.aPC);
        b.a(parcel, 8, wakeLockEvent.aPx);
        b.a(parcel, 10, wakeLockEvent.aPF);
        b.c(parcel, 11, wakeLockEvent.aPq);
        b.a(parcel, 12, wakeLockEvent.aPD);
        b.a(parcel, 13, wakeLockEvent.aPG);
        b.c(parcel, 14, wakeLockEvent.aPE);
        float f = wakeLockEvent.aPH;
        b.b(parcel, 15, 4);
        parcel.writeFloat(f);
        b.u(parcel, t);
    }
