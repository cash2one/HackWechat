...
public final class a {
    public static int a(InputStream inputStream, InputStream inputStream2, File file) {
        ...
        byte[] u = b.u(inputStream);
        byte[] u2 = b.u(inputStream2);
        int length = u.length;
        int length2 = u2.length;
        DataInputStream dataInputStream = new DataInputStream(new ByteArrayInputStream(u2, 0, length2));
        dataInputStream.skip(8);
        long readLong = dataInputStream.readLong();
        long readLong2 = dataInputStream.readLong();
        int readLong3 = (int) dataInputStream.readLong();
        dataInputStream.close();
        InputStream byteArrayInputStream = new ByteArrayInputStream(u2, 0, length2);
        ...
        byteArrayInputStream = new ByteArrayInputStream(u2, 0, length2);
