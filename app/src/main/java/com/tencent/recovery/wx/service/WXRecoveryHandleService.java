...
public class WXRecoveryHandleService extends RecoveryHandleService {
    ...
    public void onCreate() {
        ...
        this.tib = (PowerManager) getSystemService("power");
    }
    ...
    protected final RecoveryHandleResult a(Context context, RecoveryData recoveryData, ArrayList<RecoveryHandleItem> arrayList, boolean z) {
        ...
        if (NetUtil.isConnected(this)) {
            RecoveryLog.i("Recovery.WXRecoveryHandleService", "recoveryConfigUrl %s", recoveryData.zRz);
            String a2 = a(r0, a);
            if (a2 != null) {
                ...
                if (jSONObject != null) {
                    ...
                    if ((Util.gk(this) % optInt == optInt2 ? 1 : null) != null) {
    ...
    private RecoveryHandleItem a(RecoveryData recoveryData, String str) {
        ...
        recoveryHandleItem.ned = recoveryData.ned;
        ...
        String gn = NetUtil.gn(this);
        boolean isScreenOn = this.tib.isScreenOn();
        boolean aaN = aaN("dldir1.qq.com");
        recoveryHandleItem.zRB = gn + "|" + isScreenOn + "|" + aaN + "|" + aaN("www.qq.com");
...
*/
    ...
    L_0x0072:
        ...
        goto L_0x0026;
    L_0x0074:
        r0 = com.tencent.recovery.wx.util.WXUtil.aaO(r10);
    ...
    L_0x009e:
        r2 = com.tencent.recovery.wx.util.WXUtil.HM(r2);	 Catch:{ Exception -> 0x0181, all -> 0x0174 }
...
*/
    ...
    L_0x0039:
        ...
        goto L_0x0025;
    L_0x003b:
        r0 = com.tencent.recovery.wx.util.WXUtil.aaO(r8);
    ...
    L_0x0065:
        r2 = com.tencent.recovery.wx.util.WXUtil.HN(r2);	 Catch:{ Exception -> 0x011b, all -> 0x0106 }
