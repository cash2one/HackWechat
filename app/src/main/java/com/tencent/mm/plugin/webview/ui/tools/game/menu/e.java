...
public final class e extends j {
    ...
    private View b(int i, View view, LayoutParams layoutParams) {
        ...
        if (aZW()) {
            window.setGravity(5);
            window.setWindowAnimations(R.m.eYT);
        } else {
            window.setGravity(80);
            window.setWindowAnimations(R.m.eYJ);
        }
        ...
        ViewGroup viewGroup = (ViewGroup) LayoutInflater.from(this.mContext).inflate(R.i.dkP, null);
        View findViewById = viewGroup.findViewById(R.h.bp);
        if (i != 0 && view == null) {
            view = getLayoutInflater().inflate(i, viewGroup, false);
        }
        if (aZW()) {
            frameLayout = (FrameLayout) viewGroup.findViewById(R.h.cvR);
        } else {
            frameLayout = (FrameLayout) viewGroup.findViewById(R.h.cvQ);
        }
