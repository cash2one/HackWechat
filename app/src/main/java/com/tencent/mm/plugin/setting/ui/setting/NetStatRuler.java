...
class NetStatRuler extends View {
    ...
    public void onDraw(Canvas canvas) {
        ...
        textPaint.setTextSize((float) getContext().getResources().getDimensionPixelSize(R.f.bvX));
        Rect rect = new Rect();
        getDrawingRect(rect);
        ...
        canvas.drawText(bh.fK((long) ((NetStatUnit.max * 2) / 3)), paddingLeft, f, textPaint);
        canvas.drawText(bh.fK((long) (NetStatUnit.max / 3)), paddingLeft, f2, textPaint);
        canvas.drawText(bh.fK(0), paddingLeft, f3, textPaint);
    }
}
