...
public final class a extends View {
    private e a;
    private final int[] b = new int[]{12000000, 6000000, 3000000, 1500000, 800000, 400000, 200000, 100000, SQLiteDatabase.SQLITE_MAX_LIKE_PATTERN_LENGTH, 25000, 12000, 6000, 3000, 1500, 800, 400, 200, 100, 50, 25, 17, 8, 4};
    private int c = 0;
    private String d = "";
    private int e = 0;
    private int f = 0;
